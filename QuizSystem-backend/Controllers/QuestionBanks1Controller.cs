...
namespace QuizSystem_backend.Controllers
{
    ...
    [ApiController]
    public class QuestionBanks1Controller : ControllerBase
    {
        private readonly QuizSystemDbContext _context;

        public QuestionBanks1Controller(QuizSystemDbContext context)
        {
            _context = context;
        }

        // GET: api/QuestionBanks1
        [HttpGet]
